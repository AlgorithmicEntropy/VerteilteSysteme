...
%- Funktionssicherheit\\
%- Wartbarkeit\\
Ausfälle und Störungen eines Teilsystems gänzlich vorzubeugen ist sehr schwer -- wenn nicht unmöglich. Daher sollte ein zentrales Ziel eines verteilten Systems die Gewährleistung einer gewissen Fehlertoleranz sein.
